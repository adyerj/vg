...
export default function ValuedBySection() {
  ...
  return (
    <section id="valued-by" className="py-20 bg-gradient-to-b from-white to-slate-50" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-800 mb-4">
            Who Values Retention Metrics Most?
          </h2>
        ...
        >
          <a 
            href="#contact" 
            className="inline-flex items-center justify-center px-6 py-3 bg-primary hover:bg-primary/90 text-white font-medium rounded-md shadow-md transition-colors"
          >
            Discover Your Retention Gap
